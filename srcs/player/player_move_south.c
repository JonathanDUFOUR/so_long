...
/*   Updated: 2022/05/03 00:30:53 by jodufour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
inline static void	__init(
	...
	t_uint hit[2][2])
{
	p->img = &c->player[SOUTH][p->animate_idx];
...
/**
	@brief	Move the given player to its south axis if available.
