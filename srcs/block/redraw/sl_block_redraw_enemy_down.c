...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/03 03:49:36 by jodufour          #+#    #+#             */
/*   Updated: 2021/09/03 04:57:34 by jodufour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	redraw the enemy_down image to window
...
int	sl_block_redraw_enemy_down(t_huint idx_enemy)
{
	...
	if (ret == SUCCESS)
		ret = sl_block_draw(idx_enemy, MAP_CHAR[ENEMY_DOWN]);
	return (ret);
}
